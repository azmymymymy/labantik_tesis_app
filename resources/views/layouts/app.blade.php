...
<head>
    ...
    <meta name="description" content="@yield('meta-description', 'viho admin is super flexible, powerful, clean & modern responsive bootstrap 4 admin template with unlimited possibilities.')">
    <meta name="keywords" content="@yield('meta-keywords', 'admin template, viho admin template, dashboard template, flat admin template, responsive admin template, web app')">
