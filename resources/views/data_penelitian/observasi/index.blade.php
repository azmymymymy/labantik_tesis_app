                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title mb-0">Data Observasi</h4>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
                            ...
                            <div>
                                <span class="badge badge-info">Total Data: {{ $observasi->count() }}</span>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table table-bordered table-striped" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">Belum ada data observasi.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                ...
                <form action="{{ route('observasi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="file" name="data_observasi"
