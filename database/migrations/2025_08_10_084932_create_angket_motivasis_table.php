...
return new class extends Migration
{
    ...
    {
        Schema::create('angket_motivasis', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('pertanyaan_8')->nullable();
            $table->integer('pertanyaan_9')->nullable();
            $table->integer('pertanyaan_10')->nullable();
            $table->integer('total');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('angket_motivasis');
    }
};
